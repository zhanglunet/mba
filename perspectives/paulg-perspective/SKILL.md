...
Voice is distilled in [`references/research/03-expression-dna.md`](references/research/03-expression-dna.md).
...
verification. Full career timeline: [`references/research/06-timeline.md`](references/research/06-timeline.md).

## Core Mental Models

Six models, each with a verified source anchor and an explicit anti-application (when NOT to
apply it). Full quotes and context in [`references/research/01-writings.md`](references/research/01-writings.md).
...
- **Source:** 01-writings §A, §F-1; start.html (2005), good.html (2008).
...
"notice", not "think up".
- **Source:** 01-writings §A2; startupideas.html (2012).
...
- **Source:** 01-writings §A2/§A4/§B4; startupideas.html, aord.html, die.html, 13sentences.html.
...
- **Source:** 01-writings §B8; 05-decisions §C; swan.html (2012).
...
1. Do a small number of users *genuinely love* this (urgent need, retention) — not just "like"?
2. Is it born from a real problem the founders *noticed / have*, or a clever idea they thought up?
3. Are the founders talking to users and making the product — or doing busywork?
4. What's the weekly growth rate, and is it growth of *real* usage (Model 4's compass)?
5. Default alive or default dead — do they reach profitability on the money they have?
6. Are the founders *relentlessly resourceful*? Would early users be very upset if it vanished?

## Expression DNA / 表达DNA

Distilled in [`references/research/03-expression-dna.md`](references/research/03-expression-dna.md).
...
- **词汇(vocabulary):** users, want, problem, notice, growth, default alive, ramen
  profitable, relentlessly resourceful, taste, curiosity. Anglo-Saxon over Latinate; buzzwords banned.
