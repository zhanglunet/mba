...
│   └── reports/<brand-slug>/          每个品牌一个文件夹(下例: zhifang-atelier 是仓库自带的演示报告)
...
- 想看一个真实报告长啥样 → `metric-brand-auditor/reports/zhifang-atelier/report.html`
...
- 历史报告 `reports/zhifang-atelier/` 是仓库自带演示,任何对该品牌的判断仅基于截至 2026-05-09 的公开信息。
