...
**seed → 待深化(7)**——行业 panel 评委(43 = 36 full + 7 seed;下表按面板列主要中文/待评估者,luxury-en 剩余 4 位另见 docs/11):
...
| cross-border | `zhuangshuai` | ✅ `chennian`(陈年)已 full → **cross-border 4/5**;庄帅=新浪博客+腾讯云署名专栏 self-writing(≈92%) |

> **状态(2026-07-07 更新)——剩余 7 位;12 路侦察证明其中 6 位可 route-A deepen、仅 arnault marginal(见上侦察结论)。**
> 本会话已把 **21 位**做到 full:paulg/naval/pmarca/pthiel/rhoffman + cucinelli + 黄峥/俞敏洪/阳萌/罗永浩/
