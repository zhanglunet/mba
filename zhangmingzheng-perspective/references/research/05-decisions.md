# 張明正 / Steve Chang 關鍵決策 調研

調研日期: 2026-05-20
範圍: 1988–2024 之間，可從一手 / 半一手公開資料溯源的「對品牌、組織、產品線
影響重大」的決策。**重點是決策本身、決策背景、外部信號**，
而非事後 PR 化的合理化。

排除: 內部 KPI 變化、無 SEC / 新聞稿 / 官方訪談支撐的傳聞。
...
## D8. 2005 InterMute 收購 — 跨入反間諜
- 2005-05 趨勢收購美國反間諜公司 InterMute，USD 15M；整合 SpySubtract 產品線。
- Eva Chen 接 CEO 後第一個重大收購 — 對外傳達「Eva 不只是接班，也會出手」。
- 來源: Wikipedia Trend Micro + https://en.wikipedia.org/wiki/SpySubtract
...
## D11. 2008-02 Identum 收購 (Bristol 大學分拆)
- 2008-02 趨勢收購英國 Identum (Bristol 大學分拆，ID-based email encryption)，
  價格未公開，改名 Trend Micro (Bristol)。
- 對 SKILL.md「亞洲公司用全球標準證明自己」— 把研發網路延伸到歐洲。
- 來源: Wikipedia Trend Micro 條目摘要
...
## D15. 2017 SPN 演進到雲規模 AI + 2020 Cloud One 平台
- 2017 SPN 加入 machine learning + behavioral analysis；推出 XGen Endpoint Security。
- 2019–2020 Deep Security as a Service 整合進 Trend Cloud One — Workload Security 平台。
- 對 SKILL.md「迁移能力穿越周期」是中段 + 後段證據。
- 來源: Trend Micro 多份新聞稿 + https://docs.trendmicro.com/en-us/documentation/article/trend-micro-cloud-one-workload-security-dsaas-info

---

## D16. 2025-08 大改組 + Anthropic 合作
- 2025-08 趨勢宣布大改組，與 Anthropic 合作 AI 安全；Eva Chen 提「3 招反擊
  AI 軟體末日」(天下雜誌 5140871)。
- 接班人 20 年後仍能用 AI 戰略修辭 — 對「制度勝於血緣」是長期延續證據。
- 來源: https://www.cw.com.tw/article/5140871

---

## D17. (傳聞 / 待驗) 2025 私募競購
- 路透 / 鉅亨網 2025 報導趨勢科技正考慮出售；多家私募巨頭被傳出參與競購。
- 即使 38 年的「亞洲創立、全球品牌」也可能進入私募整合期。
